...
//       <div
//         className={`
//           fixed top-0 left-0 h-full w-[240px] bg-white border-r border-gray-300 p-3
...
//           <div>
//             <h1 className="font-Roboto-Serif text-2xl font-semibold text-textClr leading-[22px]">GastRonomIQ</h1>
//           <p className="text-[10px] text-textClr3 font-normal mt-2.5 font-koh-Santepheap">Track items, Calculate, Together</p>
//           </div>
//         </div>
