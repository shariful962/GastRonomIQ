// // Description: This is a simple dashboard page that displays data cards, a bar chart, recent orders, and activities.
...
// // const dataCards = [
// //   { label: 'Total Subscriber', value: '1,210', icon: <LuUsers />, bgColor: 'bg-red-100' },
// //   { label: 'Non Subscriber', value: '890', icon: <LuUserX />, bgColor: 'bg-green-100' },
// // ];
...
// const Dashboard = () => {
//   // Use the i18next hook for translation
...
//     ...card,
//     label: t(card.label.toLowerCase().replace(/\s/g, "_")), // map labels to keys like 'data_label'
//   }));
...
//     //     <h1 className="font-Roboto text-3xl font-semibold text-textClr">Dashboard</h1>
//     //     <div className='max-w-md md:w-[200px] '>
//     //       <label htmlFor="" className='block mb-1 font-Inter text-base font-medium'>select language</label>
//     //       <select className="w-full p-2 rounded-md border border-gray-300 text-sm cursor-pointer bg-white" defaultValue="English">
...
//     //    {dataCards.map(({ label, value, change, positive, bgColor }, i) => (
//     //       <div key={i} className={`${bgColor}  p-5 rounded-xl shadow-md text-textClr font-Inter`}>
//     //         <p className="uppercase font-normal text-base mb-2 leading-[22px]">{label}</p>
//     //         <h2 className="text-3xl font-medium mb-2">{value}</h2>
//     //         <p className={`text-sm font-medium flex gap-x-2 items-center ${positive ? 'text-green-700 ' : 'text-red-700 '}`}>
//     //           {positive ? <FaCaretUp size={22} /> : <FaCaretDown size={22} />} {change}%
//     //         </p>
//     //       </div>
//     //     ))}
//     //   </section>
//     //       <section className="bg-white p-5 rounded-xl shadow-md mb-10  ">
//     //     <h3 className="font-semibold text-xl font-Roboto leading-[22px] text-textClr mb-8">Statistic</h3>
...
//     //         {/* <Bar dataKey="Profit" fill="#F472B6" /> */}
//     //       </BarChart>
//     //     </ResponsiveContainer>
//     //   </section>

//     //   <div className="bg-white rounded-xl shadow-md p-5  w-full ">
//     //       <h3 className="font-semibold text-xl font-Roboto leading-[22px] text-textClr mb-4.5">Recent Orders</h3>
//     //       <table className="w-full border border-gray-200 text-sm">
//     //         <thead>
//     //           <tr className="bg-gray-100 font-semibold font-Inter text-[12px] md:text-sm text-textClr/50">
//     //             <th className="px-1 md:px-4 py-1 md:py-3 text-left">Date</th>
//     //             <th className="px-1 md:px-4 py-1 md:py-3 text-left">Product</th>
//     //             <th className="px-1 md:px-4 py-1 md:py-3 text-left">Category</th>
//     //             <th className="px-1 md:px-4 py-1 md:py-3 text-left">Amount</th>
//     //           </tr>
//     //         </thead>
//     //         <tbody>
//     //           {recentOrders.map(({ date, product, category, amount }, i) => (
//     //             <tr key={i} className="border-b border-gray-200 last:border-none hover:bg-gray-50 font-Inter text-sm">
...
//     //       <h3 className="text-2xl font-bold mb-4 sticky">Activities</h3>
//     //       {activities.map(({ id, name, text, avatar }) => (
//     //         <div key={id} className="flex items-center bg-[#F3F3F3] p-3 mb-4 last:mb-0 rounded-2xl">
//     //           <img
//     //             src={avatar}
//     //             alt={name}
...
//         <div className="bg-white rounded-xl p-5 flex-1 min-w-[280px] max-h-[600px] overflow-y-auto lg:w-[20%] w-full border border-textClr/10">
//           <h3 className="text-2xl font-bold mb-4 sticky">{t("dashboard.activities")}</h3>
//           {activities.map(({ id, name, text, avatar }) => (
//             <div
//               key={id}
